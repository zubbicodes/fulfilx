...
<View className="relative z-20 bg-white pt-32 px-4">
  ...
  <View className="w-full max-w-[1296px] mx-auto mb-8"> {/* Changed to 1296px to match image */}
    ...
    The Power of Integration: Streamlining Your Online Business with <Text className="text-[#C10016]">FULFIL.X.</Text>    </Text>
  </View>
...
<View className="relative z-20 py-20">
  <View className="max-w-[1381px] mx-auto px-4">
    
    {/* Main Title */}
    <View className="w-full max-w-[660px] mb-8">
      <Text className="font-helvetica font-bold text-[40px] leading-[54px] tracking-tight text-black text-left">
    ...
    <View className="w-full max-w-[1391px] mb-12">
      <Text className="font-helvetica font-normal text-[20px] leading-[44px] text-black text-left">
      ...
      <View className="flex flex-row items-start gap-4">
        ...
        <View className="flex-1">
          <Text className="font-helvetica font-bold text-[20px] leading-[38px] text-black">
            ...
            <Text className="font-helvetica font-normal text-[20px] leading-[38px] text-black">
